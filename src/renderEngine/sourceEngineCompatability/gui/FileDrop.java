package renderEngine.sourceEngineCompatability.gui;
...
public class FileDrop {
	 ...
	 *
	 * @param out       Optional {@link PrintStream} for logging drag and
	 *                  drop messages
	 ...
	 * {@link Fetcher} inner class to return your object Just in
	 * Time. For example:
	 * 
	 * <pre>
	 * <code>
	...
	public static class TransferableObject implements Transferable {
		...
		/**
		 * Returns the custom {@link DataFlavor} associated with
		 * the encapsulated object or <tt>null</tt> if the {@link Fetcher} constructor
		 * was used without passing a {@link Class}.
		 *
		 ...
		 * the {@link DataFlavor.stringFlavor}.
		 *
